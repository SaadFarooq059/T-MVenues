...
function TikTokGlyph({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 0 0-.79-.05A6.34 6.34 0 0 0 3.15 15.8a6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V8.7a8.19 8.19 0 0 0 4.76 1.52V6.79a4.85 4.85 0 0 1-1-.1z" />
    </svg>
  )
}
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-1 text-sm text-champagne/70">
              ...
              <li>
                <a href={meta.tiktokUrl} target="_blank" rel="noreferrer" className="flex min-h-11 items-center gap-3 transition-colors hover:text-champagne">
                  <TikTokGlyph className="size-4 shrink-0 text-gold" />
                  <span className="break-all">{meta.tiktok}</span>
                </a>
              </li>
            </ul>
          </div>
