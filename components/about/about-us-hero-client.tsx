...
export function AboutUsHeroClient({
  ...
  const thumb = posterUrl || FALLBACK_THUMBNAIL
        ...
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-6 md:py-16 md:px-8">
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-12">
            <Reveal className="w-full shrink-0 space-y-6 lg:w-[38%]" y={24}>
              ...
              <h1 className={headingHero}>About Our Journey</h1>
              ...
              {showPlay ? (
                ...
                >
                  <div className="relative aspect-[16/9] w-full sm:aspect-[16/8.5]">
                    <Image
                      src={thumb}
                      alt={posterAlt || 'Katie and Lucie — T&M Venue Styling'}
                      fill
                      priority
                ...
                <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-gold/20 bg-muted sm:aspect-[16/8.5]">
                  <Image
                    src={thumb}
                    alt={posterAlt || 'Katie and Lucie — T&M Venue Styling'}
                    fill
